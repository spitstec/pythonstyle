...
pythonstyle: int testswitch(int y)
...
pythonstyle bool FileExists(tXt nam) 
...
pythonstyle: int leadspaces(tXt s) 
...
pythonstyle bool inset(char c,tXt st) 
...
pythonstyle: tXt codeOnly(tXt s) 
